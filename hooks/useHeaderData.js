...
export const useHeaderData = (params = {}) => {
  ...
  const fetchData = useCallback(async (forceRefresh = false) => {
    try {
      ...
      // Make API request - send plain object
      const response = await httpFile.post('/webapp/v1/getheader', { projectId }, {
        headers
      });
  ...
  }, [memoizedParams, getCurrentProjectId]);
