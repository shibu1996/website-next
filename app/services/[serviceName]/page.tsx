...
import DrainCleaningHero from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningHero';
import DrainCleaningAbout from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningAbout';
import DrainCleaningServices from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningServices';
import DrainCleaningProcess from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningProcess';
import WhyChooseUsSimple from '@/themes/multicolor/components/WhyChooseUsSimple';
import DrainCleaningGuarantee from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningGuarantee';
import DrainCleaningPromise from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningPromise';
import DrainCleaningRelated from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningRelated';
import DrainCleaningFAQ from '@/themes/multicolor/components/services/drain-cleaning/DrainCleaningFAQ';
import BookingSection from '@/themes/multicolor/components/BookingSection';
import ServiceSchemaMarkup from '@/themes/multicolor/components/ServiceSchemaMarkup';
...
const DrainCleaning = () => {
  ...
  }, [pathname, displayServiceName]);


  // Get locationUrl from pathname, safely handling SSR
  const locationUrl = typeof window !== 'undefined' 
    ? (pathname || window.location.pathname).split('/services/')[0] 
    : (pathname || '').split('/services/')[0];
