...
import ContactHero from '@/themes/multicolor/components/contact/ContactHero';
import ContactForm from '@/themes/multicolor/components/contact/ContactForm';
import ContactInfo from '@/themes/multicolor/components/contact/ContactInfo';
...
const ContactPageClient = () => {
  ...
  const pageTitle = `Contact Us - ${projectCategory || 'Professional Services'}`;
  const pageDescription = `Get in touch with us for professional ${projectCategory || 'services'}. Contact us today for a free quote and same-day booking.`;
